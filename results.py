...
def get_data_loaders(seq):
    ...
    dataset_test_80 = LaserData("data/Xtest.mat", split_ratio=0.8, sequence_length=seq, scaler=scaler_80, mode="test",
                                key="Xtest")
    ...
    dataset_test_100 = LaserData("data/Xtest.mat", split_ratio=1, sequence_length=seq, scaler=scaler_100, mode="test",
                                 key="Xtest")
    ...
    dataset_test_90 = LaserData("data/Xtest.mat", split_ratio=0.9, sequence_length=seq, scaler=scaler_90, mode="test",
                                key="Xtest")
...
if __name__ == "__main__":
    ...
    if flags[0] == 1:
        # ===================================================CNNLSTM==================================
        data = models["CNNLSTM"]
        test_loader_80, test_loader_90, test_loader_100, train_loader_80, train_loader_90, train_loader_100, val_loader_80, val_loader_90, dataset_80, dataset_90, dataset_100 = get_data_loaders(
            data["seq"])
        ...
        iterative_predicting_next_points(model, dataset_100, test_loader_100, 200, device)
